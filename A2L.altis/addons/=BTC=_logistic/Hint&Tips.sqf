...
obj setVariable ["BTC_cannot_drag",0,true]; // Make an object not draggable
obj setVariable ["BTC_cannot_load",0,true]; // Make an object not loadable
BTC_lift_min_h   = 7;  // Min height required to lift an object
BTC_lift_max_h   = 12; // Max height required to lift an object
BTC_lift_radius  = 5;  // You have to stay in this radius to lift an object
