...
if (BTC_def_hud == 1) then 
{
	...
	BTC_arrow_up   = "addons\=BTC=_Logistic\=BTC=_Lift\img\arrow_up_ca.paa";
	BTC_arrow_down = "addons\=BTC=_Logistic\=BTC=_Lift\img\arrow_down_ca.paa";
	BTC_complete   = "addons\=BTC=_Logistic\=BTC=_Lift\img\objective_complete_ca.paa";
	BTC_incomplete = "addons\=BTC=_Logistic\=BTC=_Lift\img\objective_incomplete_ca.paa";
};
BTC_cargo      = ObjNull;
//Functions
