...
switch ((typeOf _vehicle)) do
{
	...
	case "B_Truck_01_transport_F": {_weight = 460;};
	case "B_MRAP_01_F": {_weight = 65;};
	case "O_MRAP_02_F": {_weight = 60;};
	case "I_MRAP_03_F": {_weight = 58;};
	case "B_Heli_Light_01_F": {_weight = 190;};
	case "O_Heli_Light_02_unarmed_F": {_weight = 350;};
