...
switch (_vehicle) do
{
	...
	case "C_Offroad_01_F":
	{
		...
		[
			...
			["texture\police_offroad.paa","cop"],
	...
	case "B_MRAP_01_F":
	{
		_ret = 
		[
			["texture\swat_hunter_1.paa","cop", "texture\swat_hunter_2.paa"],
	...
	case "I_Truck_02_box_F":
	{
		_ret = 
		[
			["texture\adacone.paa","civ", "texture\adactwo.paa"]
		];
	};
