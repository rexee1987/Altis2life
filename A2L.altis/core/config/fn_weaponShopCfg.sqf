	...
	case "rebel":
	{
		switch(true) do
		{
			...
			default
			{
				["Mohammed's Jihadi Shop",
					[
						...
						["arifle_Katiba_F",nil,155000],
						["srifle_GM6_F",nil,980000],
						["srifle_DMR_01_F",nil,500000],
						["srifle_LRR_SOS_F",nil,1450000],
						["srifle_EBR_ARCO_pointer_snds_F",nil,1200000],
						["LMG_Mk200_F",nil,980000],
						...
						["launch_RPG32_F",nil,1975000],
						["RPG32_F",nil,250000],
						["muzzle_snds_B",nil,25000],
						["NVGoggles",nil,2000],
						["SmokeShellGreen",nil,1500],
						["SmokeShellRed",nil,1500],
						["muzzle_snds_H",nil,45000],
						["optic_NVS",nil,175000]
					]
				];
			};
			case (__GETC__(life_donator) == 1):
			{
				["Rebellenshop",
					[
						...
						["srifle_LRR_SOS_F",nil,950000],
						["srifle_EBR_ARCO_pointer_snds_F",nil,900000],
						["LMG_Mk200_F",nil,910000],
						["200Rnd_65x39_cased_Box",nil,12000],				
						["optic_Holosight",nil,12000],
						...
						["launch_RPG32_F",nil,1975000],
						["RPG32_F",nil,250000],
						["muzzle_snds_B",nil,24000],
						["NVGoggles",nil,1900],
						["SmokeShellGreen",nil,1400],
						["SmokeShellRed",nil,1400],
						["muzzle_snds_H",nil,41000],
						["FirstAidKit",nil,3900],
			...
			case (__GETC__(life_donator) == 2):
			{
				["Rebellenshop",
					[
						["hgun_ACPC2_F",nil,9100],
						["hgun_PDW2000_F",nil,11100],
						["SMG_02_F",nil,25000],
						["arifle_TRG20_F",nil,85000],						
						["arifle_MX_F",nil,85000],
						["arifle_MXC_F",nil,85000],
						["arifle_Katiba_F",nil,90000],
						["srifle_GM6_F",nil,850000],
						["srifle_DMR_01_F",nil,350000],
						["srifle_LRR_SOS_F",nil,900000],
						["srifle_EBR_ARCO_pointer_snds_F",nil,850000],
						["LMG_Mk200_F",nil,880000],
						["200Rnd_65x39_cased_Box",nil,11000],				
						["optic_Holosight",nil,11000],
						["optic_Arco",nil,11000],
						["optic_Hamr",nil,11000],
						["optic_Aco",nil,11000],
						["optic_ACO_grn",nil,11000],
						["acc_flashlight",nil,7800],
						["acc_pointer_IR",nil,7800],
						...
						["30Rnd_556x45_Stanag",nil,2500],
						["10Rnd_762x51_Mag",nil,2500],
						["launch_RPG32_F",nil,1475000],
						["RPG32_F",nil,190000],
						["muzzle_snds_B",nil,22000],
						["NVGoggles",nil,1800],
						["SmokeShellGreen",nil,1200],
						["SmokeShellRed",nil,1200],
						["muzzle_snds_H",nil,40000],
						["FirstAidKit",nil,3600],
						["optic_NVS",nil,110000]
					]
				];
			};
			...
			case (__GETC__(life_donator) == 3):
			{
				["Rebellenshop",
					[
						...
						["hgun_PDW2000_F",nil,11000],
						["SMG_02_F",nil,22000],
						["arifle_TRG20_F",nil,82000],						
						["arifle_MX_F",nil,82000],
						["arifle_MXC_F",nil,82000],
						["arifle_Katiba_F",nil,85000],
						["srifle_GM6_F",nil,820000],
						["srifle_DMR_01_F",nil,320000],
						["srifle_LRR_SOS_F",nil,880000],
						["srifle_EBR_ARCO_pointer_snds_F",nil,800000],
						["LMG_Mk200_F",nil,800000],
						...
						["30Rnd_556x45_Stanag",nil,2500],
						["10Rnd_762x51_Mag",nil,2500],
						["launch_RPG32_F",nil,1275000],
						["RPG32_F",nil,170000],
						["muzzle_snds_B",nil,20000],
						["NVGoggles",nil,1800],
						["SmokeShellGreen",nil,1200],
						["SmokeShellRed",nil,1200],
						["muzzle_snds_H",nil,38000],
						["FirstAidKit",nil,3400],
						["optic_NVS",nil,95000]
					]
				];
			};
