...
if((_vehicle isKindOf "Car") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship")) then
{
	...
	[[0,format["%1 dein %2 wird beschlagnahmt.",(_vehicleData select 0) select 1,_vehicleName]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	if((count crew _vehicle) == 0) then
	{
		...
		[[0,format["%1 hat dein %2's %3 beschlagnahmt",name player,(_vehicleData select 0) select 1,_vehicleName]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
