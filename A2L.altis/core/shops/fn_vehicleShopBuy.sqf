...
switch(life_veh_shop) do
{
	...
	case "civ_car_4":
	{
		...
		case "civ_car_5":
	{
		_sp = getMarkerPos "civ_car_5";
		_dir = markerDir "civ_car_5";
	};
	...
	case "civ_servt_2":
	{
		_sp = getMarkerPos "civ_servt_2";
		_dir = markerDir "civ_servt_2";
	};
	...
	case "cop_car_10":
	{
		_sp = getMarkerPos "cop_car_10";
		_dir = markerDir "cop_car_10";
	};
